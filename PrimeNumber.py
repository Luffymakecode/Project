...
def is_prime():
    ...
    while True:
        ...
        if int(number)<2:
            ...
            print("Stefan, eigher your number is too big or not a number. Please enter a valid number")
        else:
            break
    ...
    if len(dividers) != 0:
        print("{} is a prime number. It can be divided by {}".format(number, dividers))
...
def yesno():
    while True:
        ...
        if answer == "yes" or answer == "y":
            ...
            print("Your answer should be yes or no. Please enter a valid answer")
