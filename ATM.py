...
users = {"Stefan": "1234", "Nicolae": "4321", "Radoi": "4422"}
admins = {"Justin": "1122"}
usact ={"Stefan":{"balance":3000, "deposits":[], "withdrawal":[], "transfer":[]},"Nicolae": {"balance":2500, "deposits":[], "withdrawal":[], "transfer":[]}, "Radoi": {"balance":1000, "deposits":[], "withdrawal":[], "transfer":[]}}

def main():
    print("        --- Welcome to Laura Bank ---\n"
          "            --------------------\n"
          "            /      Macin      \ \n"
...
def login(users):
    while True:
        ...
        if usname not in users:
            ...
            print(usname + "Welcome to Laura Bank!")
            break
    menu(users, usact, usname, passwrd)
def menu(users, usact, usname,passwrd):
    print("Please enter the number of service\n"
          "1. Withdraw Money\n"
          "2. Deposit Money\n"
          "3. Transfer Money\n"
    ...
    while True:
        ...
        if ask == "1":
           ...
           print("You are loggin out. Thank you choosing Laura Bank. Wish to see you again")
           main()
        else:
    ...
    while True:
        ...
        if select == "1":
            ...
            if remove not in users:
                print(remove+"does not exist as an user to Laura Bank.")
                admin(users, usact)
            else:
                users.pop(remove)
                usact.pop(remove)
                print(remove+"was removed as an user to Laura Bank")
                admin(users, usact)
        elif select == "3":
            c = 1
            for i in users:
